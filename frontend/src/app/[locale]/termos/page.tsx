...
const SECTIONS: { heading: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      'O Lendly não é seguradora e não garante reembolso, substituição ou reparo em caso de dano, perda, atraso na devolução ou uso inadequado de um item. Essas situações são de responsabilidade combinada entre quem empresta e quem toma emprestado — recomendamos registrar o estado do item e as condições combinadas antes da entrega.',
    ],
  },
  {
    heading: '8. Grupos',
  ...
  {
    heading: '10. Avaliações e denúncias',
    body: [
