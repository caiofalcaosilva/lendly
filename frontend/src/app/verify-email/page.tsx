      ...
      <div className="w-full max-w-sm text-center">
        ...
        {state === 'loading' && (
          <>
            ...
            <h1 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Verificando seu e-mail…</h1>
          </>
        )}
        ...
        {state === 'success' && (
          <>
            ...
            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">E-mail verificado!</h1>
        ...
        {state === 'error' && (
          <>
            ...
            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Link inválido ou expirado</h1>
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">
              {isAuthenticated
                ? 'O link de verificação expirou ou já foi utilizado. Solicite um novo no seu perfil.'
            ...
            <Link
              ...
              className="inline-block bg-green-600 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-green-700 transition-colors"
            >
              {isAuthenticated ? 'Ir para o perfil' : 'Ir para o login'}
            </Link>
          </>
        )}
      </div>
