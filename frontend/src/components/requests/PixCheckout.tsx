  ...
  return (
    <div className="flex flex-col items-center gap-3 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
      <div className="flex items-center gap-1.5 text-sm font-medium text-gray-900 dark:text-gray-100">
        ...
        Pague via Pix pra confirmar o pedido
      </div>
      <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{formatCurrency(payment.gross_amount)}</p>
      ...
      <p className="text-xs text-gray-400 dark:text-gray-500 text-center max-w-xs">
        Assim que o pagamento for confirmado pelo seu banco, esta tela atualiza automaticamente.
      </p>
    </div>
  )
}
