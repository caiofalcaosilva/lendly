    ...
    <div className="space-y-4">
          ...
          <Controller
            ...
            render={({ field }) => (
              <input
                ...
                className={`w-full border rounded-lg px-3 py-2 pr-10 text-sm text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition ${
                  errMsg('zip_code') ? 'border-red-400 dark:border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-300 dark:border-gray-600'
                }`}
              />
            )}
          />
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div>
          ...
          {errMsg('state') && <p className="text-xs text-red-600 dark:text-red-400 mt-1">{errMsg('state')}</p>}
        </div>
      </div>
