...
def _to_response(doc: PlatformSettings) -> PlatformSettingsResponse:
    return PlatformSettingsResponse(
        ...
        claim_filing_window_hours=doc.claim_filing_window_hours,
        claim_payment_deadline_days=doc.claim_payment_deadline_days,
        claim_late_fee_percent=doc.claim_late_fee_percent,
