...
def user_to_public_response(
    ...
    return PublicUserResponse(
        ...
        reliability_score=user.reputation.reliability_score,
        reliability_count=user.reputation.reliability_count or 0,
        on_time_rate=user.reputation.on_time_rate,
        finished_loans_count=user.reputation.finished_loans_count or 0,
        avg_response_minutes=user.reputation.avg_response_minutes,
        response_count=user.reputation.response_count or 0,
        ...
        business_phone=(
            user.business_profile.business_phone if user.business_profile else None
        ),
        business_hours=(
            user.business_profile.business_hours if user.business_profile else None
        ),
        website=user.business_profile.website if user.business_profile else None,
        instagram=user.business_profile.instagram if user.business_profile else None,
        whatsapp=user.business_profile.whatsapp if user.business_profile else None,
